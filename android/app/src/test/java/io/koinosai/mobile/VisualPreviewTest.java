...
public class VisualPreviewTest {
    ...
    @Test public void portraitScreens() throws Exception {
        ...
        app.account.token="preview-fixture";app.account.validUntil=System.currentTimeMillis()+60000;app.account.account=new JSONObject().put("id","fixture").put("email","you@koinos.example");app.accountChanged();
        ...
        tab("Chat");capture("chat");tab("Models");capture("models");tab("Network");capture("network");tab("Settings");capture("settings");
    }
